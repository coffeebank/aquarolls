import{d as p,a as m,o as n,c as i,b as t,u as d,F as f,r as _,t as l,e as u}from"./index.376c9d93.js";const g=p({id:"counter",state:()=>({aniNotice:"",aniRolls:Array(),aniRandom:Array()}),getters:{},actions:{}}),v={class:"home"},R=t("div",{class:"p-12 h-[30vh] min-h-[20rem] bg-stage flex flex-wrap items-center select-none"},[t("div",{class:"w-full"},[t("h1",{class:"text-5xl font-bold"},"\u2728 Aqua Rolls \u269D"),t("p",{class:"text-2xl pt-4 pb-8"},"Come roll for waifus :)")])],-1),y={class:"flex flex-no-wrap gap-4 p-8"},x={key:0,class:"grid grid-cols-2 md:grid-cols-5 p-8 pb-16 gap-4 w-full"},b={class:"bg-gray-200 text-gray-700 border-l-4 border-gray-700 px-3 py-2 overflow-hidden shadow-lg"},w={class:"pt-2 pb-4 flex-grow"},k={class:"text-lg pb-1 font-bold"},j={class:"pb-1"},P=u("\u{1F48E}\u2002"),A=["href"],N=["src"],D={class:"py-2 flex-grow"},S={class:"text-sm"},F={key:1},a=g(),q={data(){return{}},methods:{async fetchAniRolls(){let e=[591,951,1519],o=[];for(let r in e){let s=`
          {
